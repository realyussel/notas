...
class Jotter {
     ...
     */
    public function setNotebook($name, $user, $editor, $safe, $site_name = '', $site_description = '', $home_route = '', $password = '', $public_view = false, $display_chapter = false, $display_index = false, $public = false) {

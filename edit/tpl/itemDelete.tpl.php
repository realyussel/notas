...
<div class="<?php echo $warning ? 'bg-light' : 'bg-danger text-white'; ?> p-5 rounded">
    ...
    <p class="lead">Está a punto de eliminar <?php if ($isDir) {echo 'una carpeta y todo lo que contiene';} elseif ($isNote) {echo 'un apunte';} else {echo 'el cuaderno actual y todo lo que contiene';}?>. <strong>¡No hay vuelta atrás!</strong></p>
